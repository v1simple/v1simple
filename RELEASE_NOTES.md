# V1 Simple 4.2.21 Terminal Release Notes
...
- Mutating maintenance API routes require the bundled UI's
  ...
  constrained to explicit UI/asset allowlists.
- ESP Web Tools release images now match PlatformIO's effective serial flash
  policy (`DIO`, 80 MHz, 16 MB) and validate both bootloader and embedded app
  image headers before publishing.
