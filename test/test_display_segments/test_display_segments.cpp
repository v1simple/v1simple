 ...
 *
 * Unit tests for display segment geometry and character mapping.
 *
 * Covers segment geometry and character-map edge cases. All functions are
 * pure math or lookup tables, with no Arduino
