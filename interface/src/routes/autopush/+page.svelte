						...
						{#if editingSlot === i}
							...
							<div class="grid grid-cols-2 gap-3 mt-3">
								<div class="field-control">
									...
									<select id={`slot-${i}-profile`} class="select select-sm w-full" bind:value={slot.profile}>
								...
								<div class="field-control">
									...
									<select id={`slot-${i}-mode`} class="select select-sm w-full" bind:value={slot.mode}>
								...
								<div class="field-control">
									<label class="label py-1" for={`slot-${i}-mute`}>
										<span class="field-label copy-caption">Mute Volume (0-9)</span>
									</label>
									<input
										id={`slot-${i}-mute`}
										type="number"
								...
								<div class="field-control">
									<label class="label cursor-pointer justify-start gap-3 py-1">
										...
										<span class="field-label copy-caption">Dark Mode (V1 display off)</span>
									</label>
								</div>
								<div class="field-control">
									<label class="label cursor-pointer justify-start gap-3 py-1">
