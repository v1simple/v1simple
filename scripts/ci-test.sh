...
run_step "Native linked-source pilot" python3 scripts/run_native_tests_serial.py --linked-pilot test_alp_event_latch test_api_maintenance_runtime_matrix test_ble_proxy_alloc test_obd_ble_client_race test_obd_transport_operation_barrier test_wifi_client_enable_transaction test_wifi_scan_result_owner
run_step "Native sanitized linked-source pilot" python3 scripts/run_native_tests_serial.py --env native-sanitized --linked-pilot test_alp_event_latch test_api_maintenance_runtime_matrix test_ble_proxy_alloc test_obd_ble_client_race test_obd_transport_operation_barrier test_wifi_client_enable_transaction test_wifi_scan_result_owner
