...
struct V1Settings {
    ...
    bool     gpsEnablePinActiveHigh; // EN polarity: true=active-HIGH (Adafruit 3133)
    ...
    V1Settings() :
        ...
        gpsEnablePinActiveHigh(true),  // Adafruit 3133 is active HIGH
...
struct DeviceSettingsUpdate {
    ...
    bool gpsEnablePinActiveHigh = true;
