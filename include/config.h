...
#define PACKET_ID_RESP_VERSION                                                                                         \
    0x02                                // respVersion (reply V1 sends back).
                                        // test_packet_parser pins 0x02 inbound;
                                        // 0x01 is the outbound request id.
...
#define PACKET_ID_FACTORY_DEFAULT 0x14  // reqFactoryDefault (checksummed V1 reset)
...
#define PACKET_ID_RESP_REQUEST_NOT_PROCESSED 0x65
#define PACKET_ID_INF_V1_BUSY 0x66
