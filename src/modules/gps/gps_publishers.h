...
// Global instances are defined in gps_publishers.cpp and declared in
// include/main_globals.h (module headers must not export externs — the
// extern-escape guard enforces this now that its comment masking is fixed).
