/**
 * Regression boundary: disconnect defers cleanup for claimed OBD BLE
 * operations, invalidates writes that have not claimed the link, and keeps
 * cleanup from racing an in-flight handle user.
 */
#include <unity.h>
