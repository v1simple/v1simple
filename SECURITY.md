...
Current review surfaces include BLE, the maintenance Wi-Fi web/API interface,
stored settings and backups, and the firmware release/install path. The
repository declares no support window or response-time promise.
