...
def write_fixture(root: Path) -> None:
    files = {
        ...
        "scripts/bench/camera_timing.py": b"timing verification\n",
        "scripts/bench/aligned_timeline.py": b"aligned evidence\n",
        "scripts/bench/clock_alignment.py": b"clock mapping\n",
