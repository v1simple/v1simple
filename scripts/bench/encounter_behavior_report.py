...
function renderFields(e){const o=ob(e);
 ...
 const suffix=unknownEnd?'<p class="small"><span class="tag warn">'+unknownEnd+' unresolved ending comparisons</span></p>':'';
