...
describe('colors utilities', () => {
    ...
    it('reads the six physical segment colors in meter order', () => {
        ...
        // Every segment survives verbatim, including ones no ramp could produce.
        const distinct = {
            bar1: 0x001f,
            bar2: 0x07e0,
            bar3: 0xffe0,
        ...
        expect(ramp).toEqual([0x001f, 0x07e0, 0xffe0, 0xf800, 0xf81f, 0xffff]);

        // A flat palette stays flat.
    ...
    it('derives six segment colors from three gradient stops', () => {
