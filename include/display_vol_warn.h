...
struct VolumeZeroWarning {
    ...
    bool evaluate(bool volZero, bool proxyConnected, bool speedVolZeroActive = false) {
    ...
    bool needsFlashRedraw(bool volZero, bool proxyConnected, bool speedVolZeroActive = false) const {
