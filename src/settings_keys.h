...
inline constexpr const char* kNvsWifiStaSlotSsid[kNvsWifiStaSlotCount] = {
    "sta0Ssid", "sta1Ssid", "sta2Ssid", "sta3Ssid"
};
inline constexpr const char* kNvsWifiStaSlotLabel[kNvsWifiStaSlotCount] = {
    "sta0Label", "sta1Label", "sta2Label", "sta3Label"
};
inline constexpr const char* kNvsWifiStaSlotPriority[kNvsWifiStaSlotCount] = {
    "sta0Prio", "sta1Prio", "sta2Prio", "sta3Prio"
};
inline constexpr const char* kNvsWifiStaSlotLastConnected[kNvsWifiStaSlotCount] = {
    "sta0Last", "sta1Last", "sta2Last", "sta3Last"
};
...
inline constexpr const char* kNvsWifiStaSlotPassword[kNvsWifiStaSlotCount] = {
    "sta0Pass", "sta1Pass", "sta2Pass", "sta3Pass"
};
...
inline constexpr const char* kNvsCleanShutdn = "cleanShutdn";  // set true at end of prepareForShutdown(); read+reset at boot
