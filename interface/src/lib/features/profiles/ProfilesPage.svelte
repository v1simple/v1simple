<script>
	...
	async function saveCurrentProfile() {
		...
		const settingsToSave = editingSettings && editedSettings ? editedSettings : currentProfile?.settings;
...
<div class="page-stack">
	...
	>
		<div class="badge {$isMaintenance ? 'badge-info' : v1Connected ? 'badge-success' : 'badge-warning'}">
			{$isMaintenance ? 'Offline authoring' : v1Connected ? 'V1 Connected' : 'V1 Disconnected'}
		</div>
	</PageHeader>
	...
	<div class="surface-note copy-muted space-y-1">
		...
		<p><strong>Pull:</strong> Read current V1 settings during normal runtime, not maintenance</p>
		...
		<p><strong>Push:</strong> Send a saved profile to your V1 during normal runtime, not maintenance</p>
	</div>
</div>
