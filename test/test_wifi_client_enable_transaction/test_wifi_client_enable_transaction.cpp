/**
 * Regression boundary: client enablement commits only after startup succeeds,
 * preserves prior state on failure, and rejects incomplete callbacks.
 */
#include <unity.h>
...
void test_success_commits_once_after_start() {
    FakeRuntime fake;
