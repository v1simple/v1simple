...
void test_v1_live_trace_compares_signal_bars_to_raw_v1_context() {
    RenderFrame frame{};
    frame.primaryKind = RenderFramePrimaryKind::V1_LIVE;
    frame.context = makeState();
...
void test_trace_snapshots_cover_v1_alp_persisted_and_idle_contracts() {
    ...
    assertTraceSnapshot(
        ...
        "freq=0>0/NA bogey=2>2/M mute=1>0/NA bars=6>6/M");
...
int main() {
    ...
    RUN_TEST(test_v1_live_trace_compares_signal_bars_to_raw_v1_context);
