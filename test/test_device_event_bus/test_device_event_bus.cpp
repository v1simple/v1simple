 ...
 *
 * Regression citation: original public incident suite at commit 5c9c966
 * (2026-07-28), lines 12-16: a forced task delete while holding the real
 * portMUX froze the device.
 */
