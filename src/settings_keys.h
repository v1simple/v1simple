...
inline constexpr const char* kNvsLegacyColorBar3 = "colorBar3";
inline constexpr const char* kNvsLegacyColorBar4 = "colorBar4";
inline constexpr const char* kNvsLegacyColorBar5 = "colorBar5";
inline constexpr const char* kNvsLegacyColorBar6 = "colorBar6";

// v11 eight-segment colours, retained as a migration/downgrade shadow.
inline constexpr const char* kNvsColorBarSeg1 = "colorBarS1";
inline constexpr const char* kNvsColorBarSeg2 = "colorBarS2";
inline constexpr const char* kNvsColorBarSeg3 = "colorBarS3";
inline constexpr const char* kNvsColorBarSeg4 = "colorBarS4";
inline constexpr const char* kNvsColorBarSeg5 = "colorBarS5";
inline constexpr const char* kNvsColorBarSeg6 = "colorBarS6";
