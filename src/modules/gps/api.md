...
Wires publishers (optional), sets baud and enable polarity.
...
Updates polarity; takes effect on the next enable toggle.
...
**Source:** `gps_observation_log.h:36-39`.
...
#### `struct Runtime`
**Source:** `gps_api_service.h:10-13`.

Single callback: `void (*markUiActivity)(void* ctx)` for keep-alive signaling.
