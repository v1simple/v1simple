...
inline constexpr int SD_BACKUP_VERSION = 22;
inline constexpr int SD_EXACT_BACKUP_MIN_VERSION = 21;
...
// v12: the display returns to six physical segments. colorBar1..6 are again
// authoritative; v11 colorBarS1..8 values are collapsed without resetting the
// user's theme, and an eight-value shadow is still written for downgrade/API
// compatibility.
