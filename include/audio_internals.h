/**
 * Shared audio state, buffers, hardware handles, logging, and constants.
 */
...
// LittleFS reads disable the SPI cache, making PSRAM inaccessible; this task's
// stack must therefore reside in internal SRAM.
