/**
 * Regression boundary: BLE bond snapshots enter a nonblocking Core-0 writer,
 * coalesce when full, retry failures, and close cleanly around shutdown,
 * without filesystem work in runtime callers.
 */
#include <unity.h>
