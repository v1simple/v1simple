...
// Firmware Version
#define FIRMWARE_VERSION "4.2.14"
...
#define V1_NOTIFY_ALT_UUID      "92A0BCE0-9E05-11E2-AA59-F23C91AEC05E"  // Additional notify characteristic - compatibility stub; proxy never notifies on it but companion apps (V1Driver, JBV1, etc.) expect the UUID present in the V1 attribute table
...
#define PACKET_ID_RESP_VERSION  0x02  // respVersion (reply V1 sends back). Per
