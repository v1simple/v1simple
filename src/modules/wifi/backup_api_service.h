...
using BackupSnapshotBuildWithOptionsFn = void (*)(JsonDocument&,
                                                  uint32_t snapshotMs,
                                                  bool includeWifiPasswords,
                                                  void* ctx);
...
struct BackupRuntime {
    ...
    // Optional builder for explicit, uncached password-including exports.
    BackupSnapshotBuildWithOptionsFn buildDocumentWithOptions = nullptr;
};
