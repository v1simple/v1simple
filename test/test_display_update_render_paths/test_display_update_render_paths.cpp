...
void test_bands_plus_frequency_still_under_cap_takes_partial_flush() {
    ...
    //
    // NOTE: arrow + frequency *does* exceed the cap in production (arrow rect
    // extends down to y=166 while freq zone ends at y=115; bbox height=146 is
    // nearly the full panel). That case correctly falls into the UnionExceeds
