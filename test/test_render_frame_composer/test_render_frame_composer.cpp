...
void test_compose_v1_live_signal_bars_follow_raw_v1_led_bitmap() {
    AlertData alerts[] = {
...
void test_compose_v1_live_laser_signal_bars_still_follow_v1_led_bitmap() {
...
int main() {
    ...
    RUN_TEST(test_compose_v1_live_signal_bars_follow_raw_v1_led_bitmap);
    RUN_TEST(test_compose_v1_live_signal_bars_ignore_alert_row_strength);
    RUN_TEST(test_compose_v1_live_laser_signal_bars_still_follow_v1_led_bitmap);
